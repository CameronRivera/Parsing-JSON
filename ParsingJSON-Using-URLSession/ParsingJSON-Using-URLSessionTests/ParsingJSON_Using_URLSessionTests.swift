//
//  ParsingJSON_Using_URLSessionTests.swift
//  ParsingJSON-Using-URLSessionTests
//
...
import XCTest
@testable import ParsingJSON_Using_URLSession

class ParsingJSON_Using_URLSessionTests: XCTestCase {
...
""".data(using: .utf8)!
        ...
        do {
            ...
            // Assert
            XCTAssertEqual(firstStation.capacity, expectedCapacity)
        } catch {
